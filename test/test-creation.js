...
/*
* Entity sub generator tests
*/
describe('jhipster:app', function () {
...
* Entity sub generator tests
*/
describe('jhipster:entity', function () {
      describe('JHipster entity sub-generator ', function () {
          before(function (done) {  
              var entityJson = {
                      "relationships": [
                      ],
                      ...
                      "changelogDate": "20150801121005",
                      "dto": "no",
                      "pagination": "no"
              },
              jhipsterConfigDirectory = '.jhipster',
              filename = jhipsterConfigDirectory + '/' + 'FooEntity' + '.json';
              ...
              helpers.run(path.join(__dirname, '../app'))
                  ...
                  .withPrompts({
                      ...
                      "searchEngine": "no" })
            .on('end', function () {
                  fs.mkdir(jhipsterConfigDirectory, function(err){
                        if (err) throw err;
                        fs.writeFile(filename, JSON.stringify(entityJson), {encoding : 'utf8'}, function(err) {
                              if (err) throw err;
